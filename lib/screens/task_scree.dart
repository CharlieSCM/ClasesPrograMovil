...
import 'package:login/provider/notificacion_provider.dart';
import 'package:login/models/task_model.dart';
import 'package:login/widgets/TaskWidget.dart';
...
class _TaskScreenState extends State<TaskScreen> {
  ...
  Future<void> notifyNearTasks() async {
    ...
    for (var element in res) {
      var task = DateTime.parse(element.fecRecordatorio!);
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
              onPressed: () async {
                var res = await agendadb!.GETALLPROFE();
                if (res.isEmpty) {
                  ArtSweetAlert.show(
                      context: context,
                                                      ...
                                                      Expanded(
                                                        child: Column(
                                                          ...
                                                          children: [
                                                            ...
                                                            Text(
                                                              "Expires: ${snapshot.data![index].fecExpiracion!}",
                                                              style: MyTextSample
                                                                      .body1(
                                                                          context)!
                                                                  .copyWith(
